...
export const metadata: Metadata = {
  title: "Inventa - Решения для переработки молока под ключ",
  description: "Проектирование, оборудование и монтаж молочных заводов. 100+ завершенных проектов с 2008 года. Комплексные решения от мини-заводов до промышленных комплексов.",
  keywords: "переработка молока, молочный завод, оборудование молочное, проектирование молочных заводов, решения под ключ",
  metadataBase: new URL("https://inventa.uz/"),
  alternates: {
    canonical: "https://inventa.uz/",
  },
  openGraph: {
    title: "Inventa - Молочные решения под ключ",
    description: "Лидирующий поставщик оборудования и решений для переработки молока. 17 лет опыта, 100+ проектов.",
    url: "https://inventa.uz/",
    siteName: "Inventa",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3Ah9MKFPAiLYJWPEswu8WowW7kP/modern-dairy-processing-factory-with-sta-1773033990783-cf4a37d7.png",
        alt: "Молочный завод Inventa",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Inventa - Решения для молочной промышленности",
    description: "Комплексные решения для переработки молока. Проектирование, поставка и монтаж оборудования.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3Ah9MKFPAiLYJWPEswu8WowW7kP/modern-dairy-processing-factory-with-sta-1773033990783-cf4a37d7.png"],
  },
  robots: {
    index: true,
    follow: true,
